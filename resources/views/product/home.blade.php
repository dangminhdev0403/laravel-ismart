            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="{{ asset('product/public/images/img-pro-07.png') }}">
                            </a>
                        ...
                        <li>
                            <a href="?page=detail_product" title="" class="thumb">
                                <img src="{{ asset('product/public/images/img-pro-06.png') }}">
                            </a>
            ...
            <div class="section" id="selling-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        <li class="clearfix">
                            <a href="?page=detail_product" title="" class="thumb fl-left">
                                <img src="{{ asset('product/public/images/img-pro-05.png') }}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="?page=detail_product" title="" class="product-name">Iphone X Plus</a>
                                <div class="price">
