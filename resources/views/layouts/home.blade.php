...
ScrollReveal().reveal('.headline', { duration: 2000,container: '#list-product-wp' });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            ScrollReveal().reveal('.heading-left', {
                origin: 'left',
                distance: '200px',
                duration: 1000,
                easing: 'ease-in-out',
            ...
            ScrollReveal().reveal('.heading-left-lv2', {
                origin: 'left',
                distance: '200px',
                duration: 1500,
                easing: 'ease-in-out',
            ...
            ScrollReveal().reveal('.heading-right', {
                origin: 'right',
                distance: '200px',
                duration: 1000,
                easing: 'ease-in-out',
            ...
            ScrollReveal().reveal('.heading-right-lv2', {
                origin: 'right',
                distance: '200px',
                duration: 1500,
                easing: 'ease-in-out',
            ...
            ScrollReveal().reveal('.heading-right-lv3', {
                origin: 'right',
                distance: '250px',
                duration: 2700,
                easing: 'ease-in-out',
